...
if __name__ == "__main__":
    ...
    runs = [r for r in runs if r.name.startswith("reuseshared_tm_18x20_v10_360k_TinyMol_CNO_rot_dist")]
    print(f"Found {len(runs)} matching runs")

    metadata = dict(
        experiment="2023-03-01_gao_reuseshared_from_tinymol_360k",
        source="dpe",
        method="reuseshared",
        embedding="dpe256",
        orbitals="gao_4fd",
        reuse_from="360kshared_tinymol_v10",
        n_pretrain_variational=360_000,
