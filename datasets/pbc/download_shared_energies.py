...
if __name__ == "__main__":
    ...
    runs = [r for r in runs if r.name.startswith("MoonV6_shared_H_bcc_2x2x2_5geom_gamma_rep1")]
    print(f"Found {len(runs)} matching runs")
    metadata = dict(
        experiment="2023-10-06_MoonTAO_shared_Hbcc_rep1",
        source="dpe",
        method="shared",
        embedding="moon",
        orbitals="tao_4fd",
