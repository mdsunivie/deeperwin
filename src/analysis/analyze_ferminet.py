...
d = "/Users/leongerard/Desktop/JAX_DeepErwin/data/O2/res"
...
plot_smoothend_data(df['step'][:40000], np.sqrt(df['variance'][:40000]), axis=axes, label="FermiNet Optimization")
axes.set_ylim([0, 1])
plot_smoothend_data(df['step'][40000:], np.sqrt(df['variance'][40000:]), axis=axes, label="FermiNet Evaluation")
