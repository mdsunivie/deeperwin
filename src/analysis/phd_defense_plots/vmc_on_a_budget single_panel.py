...
experiments = [
    ("2023-02-26_18x20_500karxiv_v10_500k", "Previous method (HF input) ", "C2", "-", "s"),
    ("2023-05-01_699torsion_nc_by_std_256k", "Improved method (Neural Net input)", "C1", "-", "o"),
    ("2023-05-08_dpe4_regression", "Gerard et al. (2022)", "C4", "--", "^"),
    ("2023-05-08_psiformer_indep", "PsiFormer", "C2", "--", "v"),
    ("HF_CBS_234", "HF-CBS", None, None, "d"),
    ("CCSD(T)_ccpCVDZ", "CC-2Z", None, None, "d"),
    ("CCSD(T)_ccpCVTZ", "CC-3Z", None, None, "d"),
    ("CCSD(T)_ccpCVQZ", "CC-4Z", None, None, "d"),
]
...
for exp_name, label, color, ls, marker in experiments:
    df_filt = df.query(f"experiment == @exp_name and n_heavy >= 2")
    df_filt = df_filt[((df_filt.source == "dpe") & (df_filt.method == "reuse")) | (df_filt.source.str.contains("orca"))]
...
fname = "/home/mscherbela/ucloud/results/defense/vmc_on_a_budget_0shot.png"
