...
experiments = [
    ("2023-02-26_18x20_500karxiv_v10_500k", "Previous method (Nature Comm.) ", "C0", "-", "s"),
    ("2023-05-01_699torsion_nc_by_std_256k", "Improved method (NeurIPS)", "C1", "-", "o"),
...
for ind_epoch, (ax, epochs) in enumerate(zip(axes_n_heavy, [0, 4000])):
    for exp_name, label, color, ls, marker in experiments:
        ...
        ax.errorbar(
            ...
            label=(label if is_dpe and ind_epoch == 0 else None),
...
fname = "/home/mscherbela/ucloud/results/defense/vmc_on_a_budget.png"
