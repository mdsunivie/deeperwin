...
log_psi_squared, _, _ = build_log_psi_squared(config.model, config.physical)
# log_psi_squared_baseline, _, _ = build_log_psi_squared_baseline_model(config.model.baseline, config.physical)
