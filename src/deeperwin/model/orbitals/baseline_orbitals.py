...
def get_slater_matrices_HF(diff_el_ion, dist_el_ion, n_up: int, orbital_params: OrbitalParamsType, determinant_schema):
...
def get_slater_matrices_CI(diff_el_ion, dist_el_ion, n_up: int, orbital_params: OrbitalParamsType, determinant_schema):
    mo_matrix_up, mo_matrix_dn = _eval_molecular_orbitals_up_and_down(diff_el_ion, dist_el_ion, n_up, orbital_params)
...
def get_baseline_slater_matrices(
    diff_el_ion, dist_el_ion, n_up: int, orbital_params: OrbitalParamsType, determinant_schema
):
    """
