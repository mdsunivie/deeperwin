...
if __name__ == "__main__":
    ...
    parser.add_argument("--convert-param-name", type=str2bool, nargs="?", const=True, default=False)
    parser.add_argument("--dump-mcmc-state", type=str2bool, nargs="?", const=True, default=False)
    parser.add_argument("--dump-fixed-params", type=str2bool, nargs="?", const=True, default=False)
    parser.add_argument("--dump-clipping-state", type=str2bool, nargs="?", const=True, default=False)
