...
from deeperwin.utils import get_extent_for_imshow
import glob
...
if __name__ == '__main__':
    dpe_forces_dir = "/home/mscherbela/runs/PES/H10_forces/H10_forces_kfac_0.01_0.2"
    dpe_energies_dir = "/home/mscherbela/runs/PES/H10_forces/h10_indep_kfac"
    ...
    fig, axes = plt.subplots(1,3,figsize=(11,4), gridspec_kw={'width_ratios': [1.2, 1, 1]})
    ...
    ax_PES.quiver(aa, xx, Fa_ref, Fx_ref, color='r', alpha=0.8, zorder=2, scale=5, width=0.02, headlength=1.5, headaxislength=1.5, headwidth=2)
    ...
    ax_scatter.scatter(df_with_ref.Fx_ref, df_with_ref.Fx, label=f"$F_x$: ($r^2$={r2_x:.3f})", color='k', marker='D', alpha=0.6)
    ax_scatter.scatter(df_with_ref.Fa_ref, df_with_ref.Fa, label=f"$F_a$: ($r^2$={r2_a:.3f})", color='k', marker='o', alpha=0.6)
