...
#%%
labels=dict(adam="DeepErwin w/o weight-sharing\n+ Adam (~110k parameters)", kfac="DeepErwin w/o weight-sharing\n+ KFAC (~110k parameters)", paulinet="PauliNet + Adam\n(~150k parameters)")
...
df_dump = pd.DataFrame(dict(molecule=molecules,
                            deeperwin_kfac_mHa=energy_errors['kfac'],
                            deeperwin_adam_mHa=energy_errors['adam'],
                            paulinet_mHa=energy_errors['paulinet']))
df_dump.to_csv('/home/mscherbela/ucloud/results/paper_figures/jax/figure_data/Fig1_accuracy_no_weight_sharing.csv', index=False)
