...
markers = dict(
    Indep="o", ReuseIndep="s", ReuseShared95="s", ReuseFromIndep="s", ReuseFromIndepSingleLR="o", Shared_95="o"
)
labels = dict(
    Indep="Independent opt.",
    ReuseIndep="Independent opt. (20 geom.)",
    ReuseShared95="Reuse from 95%-shared opt.",
    ReuseFromIndepSingleLR="Full-weight-reuse from indep. opt.",
