...
kind='tall' # talll
labels = dict(ablation_pauli_01_NH3="Built-in approximate solution",
              copy_of_2_regression_nips_fulldet_NH3_tf32="Standard architecture")
colors = dict(ablation_pauli_01_NH3=get_cmap("inferno")(0.6),
              copy_of_2_regression_nips_fulldet_NH3_tf32=get_cmap("viridis")(0.8))
