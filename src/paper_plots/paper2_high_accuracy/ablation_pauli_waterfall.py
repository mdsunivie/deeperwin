...
ax[1].set_ylim([0, 25])
ax[1].axhline(
    published_errors[molecule], color="k", ls="--", label="Best published variational:\n[Pfau 2020], 200k epochs"
)
ax[1].legend(loc="upper right", framealpha=0.9, fontsize=9)
ax[1].set_title("CASSCF vs. exp. envelope")
...
fig_fname = "/home/mscherbela/ucloud/results/02_paper_figures_high_acc/Prior_physics.png"
