...
df_ref = df_full[df_full.experiment.str.startswith("HF_CBS") | df_full.experiment.str.startswith("CCSD")].pivot(
    index="geom", columns="experiment", values="E"
)
...
plot_df(
    ...
    **plot_kwargs,
    ls="--",
    label_dict={True: "Full training: small mol.", False: "Full training: large mol."},
)
if include_foundationa_model:
    plot_df(
        ...
        **plot_kwargs,
        ls="-",
        lw=2,
        label_dict={True: "Fine-tuning: small mol.", False: "Fine-tuning: large mol."},
    )
if include_foundationa_model:
...
if save_figs:
    fig.savefig(
        f"/home/mscherbela/Nextcloud/PhD/talks_and_conferences/2023_04_CMU/test_model_{include_foundationa_model}.png",
        dpi=400,
        bbox_inches="tight",
    )
    # fig.savefig(f"/home/mscherbela/Nextcloud/PhD/talks_and_conferences/2023_04_CMU.pdf", bbox_inches="tight")
