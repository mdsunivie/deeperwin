...
path = ""
run_names = ["ablation_dpe_06_NH3_rep1", "ablation_paulishift_08_NH3_rep1", "ablation_pauli_01_NH3_rep1", "bench_tao_dpe_NH3"]
data = [pd.read_csv(path + f"_{name}.csv") for name in run_names]
E_ref = -56.56381

fig, ax = plt.subplots(1, 1, figsize=(5, 4))

metadata = {"ablation_dpe_06_NH3_rep1": ("Gerard et al.", "C2"),
